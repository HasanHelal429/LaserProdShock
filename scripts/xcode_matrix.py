...
ROWS = [
    ...
    ("Result", "T_ss for its OWN ion mass", "750 eV", "501 eV", "155 eV", "DIFFERS", "823 * (m_i/m_i,real)^(1/3) * f_abs^(2/3), with each leg's OWN f_abs on the row above"),
    ("Result", "T_e / T_ss  <<< THE POINT", "0.86", "1.02", "1.02", "SAME", "ALL THREE sit at 0.86-1.02 of their own steady state, and the two PIC codes now land on the SAME number. No code is anomalous. At the matched 99.7 ps the 60 keV PSC leg gives 0.97, a 5% move"),
]
