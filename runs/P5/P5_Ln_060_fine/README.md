# P5_Ln_060_fine — Tier 3c fine rung (`ray_cfl` = 0.025)

**Phase.** 5, `TEST_PLAN.md` §13. Read with `P5_Ln_060`, never alone.
**Question.** How much does `E_abs` drift when **only** `ray_cfl` changes, at a corona whose
`1−r < 0.01` layer spans **1.20 cells**?
...
numerics. This rung supplies that at 1.20 cells, beside the two already measured:
