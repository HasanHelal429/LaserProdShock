...
TIER 3c REGIME MAP -- corona scale length L_n = 10.0 d_e, everything else held.
    ...
    cells there and drifted. At dz = 0.5 d_e this rung puts 10.0 d_e = 20 cells
    across L_n, i.e. 0.20 cells across 1-r < 0.01.
