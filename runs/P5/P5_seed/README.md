...
|---|---|---|---|
| `P4_lez_kin_mrreal_drift` | 4.5 `d_i0` | unset | — |
| `P5_full` (first fifth) | 11.67 `d_i0` | 20260829 | target thickening |
| **`P5_seed`** | 11.67 `d_i0` | 71828183 | **RNG alone** |
...
Identical to `P5_full`; 22040 cells, 2031000 steps = 200.8 ps.
