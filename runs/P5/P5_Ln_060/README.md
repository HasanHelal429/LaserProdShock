...
TIER 3c REGIME MAP -- corona scale length L_n = 60.0 d_e, everything else held.
    ...
    cells there and drifted. At dz = 0.5 d_e this rung puts 60.0 d_e = 120 cells
    across L_n, i.e. 1.20 cells across 1-r < 0.01.
...
1D  |  propagation axis z  |  lengths in d_e at critical density = 0.1693 um
  ...
  ~  coronal ramp   : exponential, L_n = 60 d_e on the LASER-FACING side (face at z = +0)
