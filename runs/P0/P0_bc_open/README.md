...
All under `media/P0/P0_bc_open/` — gitignored and regenerable:
...
```bash
python scripts/run_checks.py   runs/P0/P0_bc_open
python scripts/laser_report.py runs/P0/P0_bc_open
/opt/anaconda3/envs/physics/bin/python scripts/plot_fields.py runs/P0/P0_bc_open
/opt/anaconda3/envs/physics/bin/python scripts/phase_space.py runs/P0/P0_bc_open
/opt/anaconda3/envs/physics/bin/python scripts/make_movies.py runs/P0/P0_bc_open
```
## Result
