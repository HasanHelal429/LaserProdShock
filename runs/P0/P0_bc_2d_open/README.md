...
2D  |  z = propagation axis (across), x = transverse (down)  |  lengths in d_e at critical density = 0.1676 um
  ...
  ~  coronal ramp   : Gaussian, L_n = 15 d_e on the LASER-FACING side (face at z = -40), drawn out to 1e-3 n_cr
  ...
  grid              : 80 x 400 cells (x by z), dz = dx = 0.5 d_e, dt = 0.09882 fs, 8000 steps = 0.7906 ps
```
