# P4_lez_kin_mr400 — does the plume `T_e` scale as `mu^(1/3)`, or not at all?

**Phase.** 4, `TEST_PLAN.md` §12. Leg 3 of 3 in the mass-ratio scan.
...
|---|---|
| `m_p/m_e` | **400** |
| `reference.mass_ratio` (`m_Al/m_e`) | 10792.6 |
| `s = √(mr/2698)` | **2** |
| target `thickness_de` | 90 (= 4.5 `d_i0`) |
